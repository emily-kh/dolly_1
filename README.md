## アプリケーション概要
- 現在コロナウイルスの影響で外出してショッピングすることが減りネットで洋服を買う方が増えました。ネットでの買い物は便利なこともありますが、私はファッションサイトで洋服を買った際家に洋服が届き着てみたら、サイズが合わないことや生地が薄かったりと、直接見ていない為失敗することが多くデメリットもあるなと思いました。そこで、これらの課題が少しでも解決できるサイトを作りたいと思い"DOLLY"というファッションサイトを制作致しました。
